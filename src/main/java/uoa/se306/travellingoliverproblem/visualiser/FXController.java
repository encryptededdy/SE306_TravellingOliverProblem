...
public class FXController {
    ...
    public void startProcessing(Graph inputGraph, int processors, boolean isParallelised, String outputName, SchedulerType type) {
        ...
        scheduleStatusText.setText(String.format("Scheduling %s onto %s processors, on %s thread(s)", inputGraph.getGraphName(), processors, (Main.forkJoinPool == null || Main.forkJoinPool.getPoolSize() == 0) ? 1 : Main.forkJoinPool.getPoolSize()));
